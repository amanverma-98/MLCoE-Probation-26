...
class Bowler(Player):
    ...
    def perform(self):
        ...
        points=wickets*20
        print(f"{self.name} take {wickets} wickets -> {points} points")
        return points
...
class AllRounder(Player):
    ...
    def perform(self):
        ...
        bowling_points=random.randint(0,40)
        total=batting_points + bowling_points
        print(f"{self.name} scores {total} points"
              f"{batting_points} batting + {bowling_points} bowling")
        return total
...
class Team:
    ...
    def buy_player(self,player,price):
        ...
        print(f"{player.name} solds to {self.name}"
              f"for {price}Cr")
        return True
...
P2 = Batsman("Rahul Dravid",10)
P3 = Batsman("Sachin Tendulkar",18) 
