...
The program will display the auction, team squads, match simulation, scores, and winner in the terminal.
...
Rohit Sharma (Batsman) → SOLD to Team Titans for ₹8.5Cr
Jasprit Bumrah (Bowler) → SOLD to Team Titans for ₹14.5Cr

=== SQUADS ===

Team Titans (Remaining Budget: ₹44.5Cr)
  - Rohit Sharma (Batsman)
  - Jasprit Bumrah (Bowler)

=== MATCH SIMULATION ===

Rohit Sharma contributes 49 points
Jasprit Bumrah contributes 40 points

Team Titans Total: 287
Team Chargers Total: 222
